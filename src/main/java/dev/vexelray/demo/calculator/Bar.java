...
final class Bar {
    ...
    Bar(Gui gui) {
        ...
        field = new TextField(gui, Canned.DEFAULT_EXPRESSION);
        field.node()
                .width(FIELD_WIDTH)
                .font(Type.MONO)
        ...
        root = gui.column()
                ...
                .gap(Type.GAP)
                .children(entry, crop, error, subtitle);
    }
    ...
    void show(Canned.Reading reading) {
        mode(reading);
    }

    private void mode(Canned.Reading reading) {
